...
function ReminderForm({ vehicles = [], selectedVehicleId, onCreate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!type || type.length > 50) {
      toast.error("Takip türü en fazla 50 karakter olabilir.");
      return;
    }

    if (amount && (Number(amount) < 0 || Number(amount) > 1000000)) {
      toast.error("Tutar 0 ile 1.000.000 arasında olmalıdır.");
      return;
    }

    if (description.length > 150) {
      toast.error("Açıklama en fazla 150 karakter olabilir.");
      return;
    }
    ...
    try {
      ...
      toast.error("Takip kaydı eklenemedi.");
      console.error(err);
    }
  };
          ...
          <div className="row g-3 align-items-end">
            ...
            <div className="col-12 col-md-2">
              ...
              <input
                ...
                style={{ borderRadius: 12, minHeight: 44 }}
              />
              <div className="text-muted small mt-1">Maks: ₺1.000.000</div>
            </div>

            <div
              className={
                selectedVehicleId ? "col-12 col-md-4" : "col-12 col-md-3"
              }
            >
              <label className="form-label small fw-semibold text-muted">
                Açıklama
            ...
            <div className="col-12 d-flex justify-content-end mt-3">
              <button
                ...
                style={{
                  ...
                  minHeight: 44,
                  background:
                    "linear-gradient(90deg, #3b60c5 0%, #284185 100%)",
                  color: "#fff",
