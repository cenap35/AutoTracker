...
const QUICK_ACTIONS = [
  ...
  },
  {
    ...
    title: "Takip ekle",
    text: "Sigorta, kasko, MTV ve muayene takip et",
    titleColor: "#0f6c8f",
    bg: "linear-gradient(110deg, #eafaff 65%, #ffffff 100%)",
  },
  {
    to: "/reports",
    icon: "bi-bar-chart-line-fill",
    iconClass: "text-warning",
    title: "Rapor Ekle Not Al",
    ...
    <PageWrapper>
      <div className="container py-4 py-lg-5">
        ...
        <section className="mb-4 mb-lg-5">
          <SectionTitle icon="bi-calendar3">Son 6 Ay Masraf Özeti</SectionTitle>
          ...
          <div className="row g-3 mb-3">
            <div className="col-md-4">
              ...
              >
                <div className="card-body">
                  ...
                  <div className="h5 fw-bold mb-0" style={{ color: "#284185" }}>
            ...
            <div className="col-md-4">
              ...
              >
                <div className="card-body">
                  <div className="text-muted small">Son 6 ay takip / diğer</div>
                  <div className="h5 fw-bold mb-0" style={{ color: "#6f42c1" }}>
            ...
            <div className="col-md-4">
              ...
              >
                <div className="card-body">
                  ...
                  <div className="h5 fw-bold mb-0" style={{ color: "#dc3545" }}>
              ...
              <div className="col-md-6 col-xl-4" key={item.month}>
                ...
                >
                  <div className="card-body p-4">
                    <div className="fw-bold mb-3" style={{ color: "#284185" }}>
