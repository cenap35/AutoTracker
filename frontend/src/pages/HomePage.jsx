        ...
        <div>
          ...
          >
            ...
            <div className="row align-items-center g-4 g-lg-5 mb-5">
              <div className="col-lg-7 text-center text-lg-start">
                ...
                >
                  ...
                  masraflarını tek ekranda yönetin. AutoTracker; sade arayüzü,
                  net özetleri ve akıllı kontrol paneliyle araç yönetimini
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(114deg, #f7faff 53%, #fff9f0 100%)",
                border: "1.3px solid #e3eafb",
