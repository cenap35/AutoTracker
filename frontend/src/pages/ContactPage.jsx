            ...
            <div className="col-lg-8">
                  ...
                  <div className="d-grid gap-3 mt-4">
                    <div className="d-flex align-items-center gap-3 p-3 rounded-3 bg-light">
                      ...
                      <div>
                        ...
                        <div className="text-muted">cenapbyrm@gmail.com</div>
                      </div>
                    </div>
              ...
              <div
                ...
                style={{
                  borderRadius: 18,
                  background:
                    "linear-gradient(120deg, #f3f8ff 0%, #fffef8 100%)",
                }}
              >
                <div className="card-body p-4">
                  ...
                  >
                    ...
                    paylaşmak için e-posta veya LinkedIn üzerinden iletişim kurulabilir.
                  </p>
                </div>
              </div>
            </div>
